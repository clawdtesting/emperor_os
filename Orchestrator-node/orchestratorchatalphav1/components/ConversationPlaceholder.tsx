...
export function ConversationPlaceholder({ me, relayToken }: ConversationPlaceholderProps) {
  ...
  const [relaySync, setRelaySync] = useState<'idle' | 'syncing' | 'ok' | 'error'>('idle');
  ...
  return (
    <section className="card">
      ...
      <div className="row">
        ...
        <button className="button ghost" onClick={() => void refreshDirectory()} disabled={busy}>Refresh relay</button>
      </div>
