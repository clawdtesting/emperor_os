...
import VerifyOwnershipComponent from '../components/VerifyOwnershipComponent';
...
export default function Home() {
  ...
  }, [isVerified, libp2p, peerStats, setPeerStats]);
  ...
  }, [isVerified, libp2p, listenAddresses, setListenAddresses]);
  ...
  if (!isVerified) {
    return (
      <>
        <Head>
          <title>AGI.Eth Subdomain Verification</title>
        </Head>
        <VerifyOwnershipComponent onVerificationSuccess={handleVerificationSuccess} />
      </>
    );
  }
  ...
  return (
    <>
      <Head>
        <title>AGI Orchestrator Chat - Universal Connectivity</title>
        <meta name="description" content="AGI Orchestrator Chat - Universal Connectivity" />
          ...
          <header>
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
              <h1 className="text-3xl font-bold leading-tight tracking-tight text-gray-900 flex flex-row">
                <p className="mr-4">AGI Orchestrator Chat via Universal Connectivity</p>
              </h1>
            </div>
          </header>
          <main>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="my-6 w-1/2">
                ...
                <button
                  type="button"
                  className="mt-3 w-full bg-gradient-to-r from-purple-600 to-blue-500 hover:from-purple-700 hover:to-blue-600 text-white font-semibold py-2 px-4 border border-blue-700 rounded shadow"
