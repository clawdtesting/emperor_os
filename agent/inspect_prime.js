...
async function main() {
  ...
  const commitPackageReady = true; // Stage 8.10 provides commit package flow
  ...
  console.log(`  Prime Commit Package Readiness: ${commitPackageReady ? "prime_commit_package_ready" : "prime_commit_package_not_ready"}`);
  console.log();
  console.log();
