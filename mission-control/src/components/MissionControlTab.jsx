...
const LANE_BLUEPRINT = [
  ...
  },
  {
    ...
    subtitle: 'Updated manager lane (contract-first)',
    tone: 'border-fuchsia-900/70 bg-fuchsia-950/20',
    tab: 'jobs-v2',
    laneFlag: 'operator-assisted · partial',
    steps: [
      ['Contract-first reads', 'active'],
      ['v2 state inspection', 'active'],
      ['v2 lifecycle surface', 'partial'],
      ['Execution controls', 'planned'],
      ['Validation controls', 'partial'],
