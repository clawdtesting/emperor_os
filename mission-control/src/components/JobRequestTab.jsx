...
export function JobRequestTab({ wallet }) {
  ...
  // Backward-compatible aliases so older JSX references never hard-crash the tab.
  const mdRaw = importRaw
  const mdWarnings = importWarnings
